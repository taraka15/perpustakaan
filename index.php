...
<html lang="en">
  <head>
    ...
    <title>smkn1jakarta.com</title>
    <link rel="icon" href="assets/logoUrl1.png" type="image/png">
  </head>
  <body>
    <!--Navbar-->
  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-gradient">SMKN1<span class="text-black">JAKARTA</span></h2>
<style>
.text-gradient {
    ...
    background-clip: text;
          ...
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">SMKN1JAKARTA</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">TARAKA BHANU W</div>
        <div class="card-body">
          <h5 class="card-title">Universitan Pamulang Student</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    Daerah Khusus Ibukota Jakarta 10710
        ...
        <div class="d-flex justify-content-center gap-4">
          <a href="https://github.com/taraka15" class="fs-3"><i class="fa-brands fa-github"></i></a>
          <a href="https://t.me/laravelapibot" class="fs-3"><i class="fa-brands fa-telegram"></i></a>
          <a href="https://www.instagram.com/smkn1jakarta_official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="fs-3"><i class="fa-brands fa-instagram"></i></a>
        </div>
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Created by <a href="" class="text-decoration-none">Taraka Bhanu W</a> © 2025</p>
        </div>
      </div>
    </footer>
